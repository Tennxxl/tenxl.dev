...
export default function SmallCTAButton() {
    return (
          <div onClick={() => window.open("https://github.com/tennxl", "_blank")} className="select-none cursor-pointer w-fit relative bg-gradient-to-b from-[#059669] to-[#047857] rounded-[47.86px] px-[6.5px] pt-[5px] pb-[6.5px] hover:p-0 shadow-slight hover:opacity-80 active:scale-[0.975] group transition-all duration-300">
